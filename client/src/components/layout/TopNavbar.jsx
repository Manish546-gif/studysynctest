            ...
            <AnimatePresence>
              {open && (
                <motion.div
                  ...
                  className="absolute right-0 top-full mt-2 w-80 max-h-[420px] bg-surface-container-low rounded-2xl shadow-xl shadow-inverse-surface/10 border border-outline-variant/30 overflow-hidden flex flex-col"
                >
